\doxysection{/\+Users/saykasz/\+Desktop/\+Dev\+\_\+\+Techniques\+\_\+game-\/of-\/life/draw/include/\+S\+D\+L2/\+S\+D\+L\+\_\+mutex.h File Reference}
\label{_s_d_l__mutex_8h}\index{/Users/saykasz/Desktop/Dev\_Techniques\_game-\/of-\/life/draw/include/SDL2/SDL\_mutex.h@{/Users/saykasz/Desktop/Dev\_Techniques\_game-\/of-\/life/draw/include/SDL2/SDL\_mutex.h}}
...
\begin{DoxyCompactItemize}
\item 
\#define \textbf{ S\+D\+L\+\_\+mutexP}(m)~S\+D\+L\+\_\+\+Lock\+Mutex(m)
\item 
\#define \textbf{ S\+D\+L\+\_\+mutexV}(m)~S\+D\+L\+\_\+\+Unlock\+Mutex(m)
\item 
...
Synchronization functions which can time out return this value if they time out. \mbox{\label{_s_d_l__mutex_8h_a3ce486805b5c21574466d3d93c908597}} 
\index{SDL\_mutex.h@{SDL\_mutex.h}!SDL\_mutexP@{SDL\_mutexP}}
\index{SDL\_mutexP@{SDL\_mutexP}!SDL\_mutex.h@{SDL\_mutex.h}}
\doxysubsubsection{SDL\_mutexP}
...
Waits for at most {\ttfamily ms} milliseconds, and returns 0 if the condition variable is signaled, \doxyref{S\+D\+L\+\_\+\+M\+U\+T\+E\+X\+\_\+\+T\+I\+M\+E\+D\+O\+UT}{p.}{_s_d_l__mutex_8h_a1214610634c24465d7c50149752791a9} if the condition is not signaled in the allotted time, and -\/1 on error.
...
In general it\textquotesingle{}s safer to signal the condition variable while the mutex is locked. \mbox{\label{_s_d_l__mutex_8h_ae1f90ad6a7420fb3c4b5685e440d762f}} 
...
Create a mutex, initialized unlocked. \mbox{\label{_s_d_l__mutex_8h_ab8c1a20a5466281a5d63a0cabe07e140}} 
...
Create a semaphore, initialized with value, returns N\+U\+LL on failure. \mbox{\label{_s_d_l__mutex_8h_a8843feeb270845e07fc23f692707540f}} 
...
Destroy a condition variable. \mbox{\label{_s_d_l__mutex_8h_ad2bbcc4e32ac927af62f0cba671f63fe}} 
...
Destroy a mutex. \mbox{\label{_s_d_l__mutex_8h_a23deb3b7e29a5137d804e4be3453a768}} 
...
Destroy a semaphore. \mbox{\label{_s_d_l__mutex_8h_a0c50f774babf7a44c381238a1f780595}} 
...
\begin{DoxyReturn}{Returns}
0 if the wait succeeds, \doxyref{S\+D\+L\+\_\+\+M\+U\+T\+E\+X\+\_\+\+T\+I\+M\+E\+D\+O\+UT}{p.}{_s_d_l__mutex_8h_a1214610634c24465d7c50149752791a9} if the wait would block, and -\/1 on error. 
\end{DoxyReturn}
...
Returns the current count of the semaphore. \mbox{\label{_s_d_l__mutex_8h_af51d75d18cb90f28b35c31e853b04792}} 
...
This function suspends the calling thread until the semaphore pointed to by {\ttfamily sem} has a positive count. It then atomically decreases the semaphore count. \mbox{\label{_s_d_l__mutex_8h_a4ea1acfaf722895626174e1e37c497da}} 
...
Variant of \doxyref{S\+D\+L\+\_\+\+Sem\+Wait()}{p.}{_s_d_l__mutex_8h_af51d75d18cb90f28b35c31e853b04792} with a timeout in milliseconds.

\begin{DoxyReturn}{Returns}
0 if the wait succeeds, \doxyref{S\+D\+L\+\_\+\+M\+U\+T\+E\+X\+\_\+\+T\+I\+M\+E\+D\+O\+UT}{p.}{_s_d_l__mutex_8h_a1214610634c24465d7c50149752791a9} if the wait does not succeed in the allotted time, and -\/1 on error.
\end{DoxyReturn}
\begin{DoxyWarning}{Warning}
On some platforms this function is implemented by looping with a delay of 1 ms, and so should be avoided if possible. 
\end{DoxyWarning}
